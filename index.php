...
<head>
	...
	<script src="js/app/achilles.js"></script>
	<script>
...
<body>
			...
			<div class="collapse navbar-collapse" id="collapse-menu">
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul id="dropdown-datasources" class="dropdown-menu">
						</ul>
					</li>
					<li>
						...
						<ul class="dropdown-menu">
							...
							<li onclick="updateReport('achillesheel');">Achilles Heel</li>
							<li onclick="updateReport('person');">Person</li>
							<li onclick="updateReport('observationperiods');">Observation Periods</li>
							<li onclick="updateReport('datadensity');">Data Density</li>
							<li onclick="updateReport('conditions');">Conditions</li>
							<li onclick="updateReport('conditioneras');">Condition Eras</li>
							<li onclick="updateReport('observations');">Observations</li>
							<li onclick="updateReport('drugeras');">Drug Eras</li>
							<li onclick="updateReport('drugs');">Drug Exposures</li>
							<li onclick="updateReport('procedures');">Procedures</li>
							<li onclick="updateReport('visits');">Visits</li>
							<li onclick="updateReport('death');">Death</li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div id="datasourceTitle" data-bind="text:datasource().name"></div>

	<div id="reportAchillesHeel" class="report">
	...
	<div id="reportObservationPeriods" class="report">
	...
	<div id="reportPerson" class="report">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-sm-12 personSummary">
	...
	<div id="reportDrugEras" class="report">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="myTab">
								<li class="active"><a href="#drugera_treemap_panel">Treemap</a>
								</li>
								<li><a href="#drugera_table_panel">Table</a>
								</li>
							</ul>
							<div id='content' class="tab-content">
								<div class="tab-pane active" id="drugera_treemap_panel">
								...
								<div class="tab-pane" id="drugera_table_panel">
		...
		<div id="reportDrugErasDrilldown" class="hidden reportDrilldown">
	...
	<div id="reportDrugExposures" class="report">
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="myTab">
								<li class="active"><a href="#drug_treemap_panel">Treemap</a>
								</li>
								<li><a href="#drug_table_panel">Table</a>
								</li>
							</ul>
							<div id='content' class="tab-content">
		...
		<div id="reportDrugExposuresDrilldown" class="hidden reportDrilldown">
	...
	<div id="reportConditionEras" class="report">
			...
			<div class="col-sm-12">
				<div class="panel panel-default panel-table">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="myTab">
								<li class="active"><a href="#conditionera-treemap-panel">Treemap</a>
								</li>
								<li><a href="#conditionera-table-panel">Table</a>
								</li>
							</ul>
							<div id='content' class="tab-content">
								<div class="tab-pane active" id="conditionera-treemap-panel">
									<div id="treemap_container">
										<div class="treemap_zoomtarget"></div>
									</div>
								...
								<div class="tab-pane" id="conditionera-table-panel">
		...
		<div id="reportConditionErasDrilldown" class="hidden reportDrilldown">
			...
			<div class="col-sm-12">
				<div class="panel panel-default panel-table">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="myTab">
								<li class="active"><a href="#condition-treemap-panel">Treemap</a>
								</li>
								<li><a href="#condition-table-panel">Table</a>
								</li>
							</ul>
							<div id='content' class="tab-content">
								<div class="tab-pane active" id="condition-treemap-panel">
									<div id="treemap_container">
										<div class="treemap_zoomtarget"></div>
									</div>
									<div class="treemap_legend">Box Size: Prevalence, Color: Records per Person (Blue to Orange = Low to High), Use Ctrl-Click to Zoom, Alt-Click to Reset Zoom</div>
								</div>
								<div class="tab-pane" id="condition-table-panel">
	...
	<div id="reportProcedureOccurrences" class="report">
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="myTab">
								<li class="active"><a href="#procedure-treemap-panel">Treemap</a>
								</li>
								<li><a href="#procedure-table-panel">Table</a>
								</li>
							</ul>
							<div id='content' class="tab-content">
								<div class="tab-pane active" id="procedure-treemap-panel">
									<div id="treemap_container">
										<div class="treemap_zoomtarget"></div>
									</div>
									<div class="treemap_legend">Box Size: Prevalence, Color: Records per Person (Blue to Orange = Low to High), Use Ctrl-Click to Zoom, Alt-Click to Reset Zoom</div>
								</div>
								<div class="tab-pane" id="procedure-table-panel">
		...
		<div id="reportProcedureOccurrencesDrilldown" class="hidden reportDrilldown">
	...
	<div id="reportObservations" class="report">
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="myTab">
								<li class="active"><a href="#observation-treemap-panel">Treemap</a>
								</li>
								<li><a href="#observation-table-panel">Table</a>
								</li>
							</ul>
							<div id='content' class="tab-content">
								<div class="tab-pane active" id="observation-treemap-panel">
									<div id="treemap_container">
										<div class="treemap_zoomtarget"></div>
									</div>
									<div class="treemap_legend">Box Size: Prevalence, Color: Records per Person (Blue to Orange = Low to High), Use Ctrl-Click to Zoom, Alt-Click to Reset Zoom</div>
								</div>
								<div class="tab-pane" id="observation-table-panel">
		...
		<div id="reportObservationDrilldown" class="hidden reportDrilldown">
	...
	<div id="reportDataDensity" class="report">
	...
	<div id="reportVisitOccurrences" class="report">
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="myTab">
								<li class="active"><a href="#visit-treemap-panel">Treemap</a>
								</li>
								<li><a href="#visit-table-panel">Table</a>
								</li>
							</ul>
							<div id='content' class="tab-content">
								<div class="tab-pane active" id="visit-treemap-panel">
									<div id="treemap_container">
										<div class="treemap_zoomtarget"></div>
									</div>
									<div class="treemap_legend">Box Size: Prevalence, Color: Records per Person (Blue to Orange = Low to High), Use Ctrl-Click to Zoom, Alt-Click to Reset Zoom</div>
								</div>
								<div class="tab-pane" id="visit-table-panel">
		...
		<div id="reportVisitOccurrencesDrilldown" class="hidden reportDrilldown">
	...
	<div id="reportDeath" class="report">
